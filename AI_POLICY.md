# homebrew-brig AI Policy

AI-assisted development is welcome in homebrew-brig.
...
A contribution is judged as a contribution to homebrew-brig, not as AI output.
...
## AI does not relax homebrew-brig's engineering rules
...
homebrew-brig may be developed using interactive assistants as well as autonomous or unattended agents.
...
We welcome research involving homebrew-brig and AI-assisted software engineering, including:
...
If an experiment produces a genuinely useful improvement to homebrew-brig, we welcome it as a contribution.
